...
final class Version20230818095831 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE figures (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, groups_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, creation_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_ABF1009A98333A1E (users_id), INDEX IDX_ABF1009A2EE7F9F3 (groups_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE figures ADD CONSTRAINT FK_ABF1009A98333A1E FOREIGN KEY (users_id) REFERENCES users (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE figures ADD CONSTRAINT FK_ABF1009A2EE7F9F3 FOREIGN KEY (groups_id) REFERENCES `groups` (id) ON DELETE SET NULL');
